...
```sh
$ git clone https://github.com/Aestherielle2/Telegram_VC_Bot-1
$ cd Telegram_VC_Bot
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Aestherielle2/Telegram_VC_Bot-1)
